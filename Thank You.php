...
<body class="bcgrd_image">
  ...
  <div style="width: 80%; margin: auto;" class="card bg-<?php echo $theme ?> text-<?php echo ($theme == 'light') ? 'dark' : 'light'; ?> mt-3">
        ...
        <p>As we express our gratitude, we want you to know that your presence is deeply appreciated. Your support motivates us to continue striving for excellence and delivering content that resonates with the diverse tastes of our movie community.</p>
        <p>We're more than just a website; we're a gathering of fellow movie enthusiasts, and you play a crucial role in shaping the atmosphere. Together, we celebrate the magic of storytelling, the thrill of cinematic adventures, and the power of shared narratives.</p>
        <p>Thank you for being a part of this cinematic journey with us. We look forward to many more shared movie moments, discussions, and discoveries in the future.</p>
